      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=url('jalan')?>"><i class="fa fa-circle-o"></i> Kelola Jalan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=url('server')?>"><i class="fa fa-circle-o"></i> Server</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=url('rekapitulasi')?>"><i class="fa fa-circle-o"></i> Lihat Rekapitulasi</a></li>
            <li><a href="<?=url('laporan')?>"><i class="fa fa-circle-o"></i> Cetak Rekapitulasi</a></li>
          </ul>
        </li>
        <?php endif ?>
        ...
        <li>
          <a href="<?=url('pengaduan')?>">
            <i class="fa fa-sign-out"></i> <span>PENGADUAN</span>
          </a>
        </li>
        <?php endif ?>
        <li>
