<?php
    ...
    $data=$db->ObjectBuilder()->getOne("tbl_user");
    if($db->count>0){
      // jika username ada
      $hash = $data->kt_sandi;
      // echo $hash;
  ...
  <div class="login-box-body">
    ...
    <form  method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nm_pengguna" placeholder="Username">
    ...
    <p class="mb-1">
    <a href="?halaman=pengaduan">Pengaduan Masyarakat</a>
    </p>
    </form>
